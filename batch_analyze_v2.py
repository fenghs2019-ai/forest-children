...
# 诗歌标题映射
POEMS = {
    "04": "念", "05": "鱼", "06": "悠", "07": "路", "08": "守", "09": "寻", "10": "蒲",
    "11": "怜", "12": "匠", "13": "荷", "14": "思", "15": "梦", "16": "树", "17": "萤",
    "18": "昙", "19": "风", "20": "舞", "21": "叶", "22": "洞", "23": "雨", "24": "石",
    "25": "蜗", "26": "蜜", "27": "星", "28": "月", "29": "心", "30": "逢", "31": "网",
    "32": "诗", "33": "琴", "34": "棋", "35": "波", "36": "暖", "37": "忆", "38": "静",
    "39": "夜", "40": "钓", "41": "术", "42": "螺", "43": "铃", "44": "果", "45": "歌",
    "46": "幻", "47": "云", "48": "蝶", "49": "露", "50": "虹", "51": "凤", "52": "画",
    "53": "舟", "54": "狐", "55": "蜓", "56": "龟", "57": "枭", "58": "鹿", "59": "冰",
    "60": "芽", "61": "醒", "62": "游", "63": "聚", "64": "雪", "65": "蛇", "66": "眠",
    "67": "醉", "68": "藏", "69": "妖", "70": "愿", "71": "年", "72": "光", "73": "诱",
    "74": "冬", "75": "春", "76": "融", "77": "明", "78": "雀", "79": "跑", "80": "马",
    "81": "夏", "82": "门", "83": "镜", "84": "湖", "85": "伤", "86": "默", "87": "香",
    "88": "恕", "89": "悲", "90": "怒", "91": "悦", "92": "悟", "93": "困", "94": "丝",
    "95": "远", "96": "战", "97": "和", "98": "智", "99": "晴", "100": "爱", "101": "晓",
    "102": "怕", "103": "想", "104": "赢", "105": "累", "106": "睡", "107": "错", "108": "病",
    "109": "归", "110": "缘", "111": "生", "112": "种", "113": "惑", "114": "变", "115": "洲",
    "116": "诺", "117": "信", "118": "义", "119": "颜", "120": "葵", "121": "法", "122": "尘",
    "123": "落", "124": "时", "125": "城", "126": "雾", "127": "别", "128": "启", "129": "解",
    "130": "补", "131": "息", "132": "榛", "133": "知", "134": "晨", "135": "行", "136": "倦",
    "137": "森", "138": "试", "139": "梯", "140": "潜", "141": "渡", "142": "忘", "143": "愁",
    "144": "清", "145": "懂", "146": "流", "147": "停", "148": "元", "149": "望", "150": "闯",
    "151": "空", "152": "真", "153": "闲", "154": "离", "155": "忙", "156": "玩", "157": "封",
    "158": "破", "159": "等", "160": "凡", "161": "祈", "162": "别"
}
...
def analyze_poem(poem_id, char, content):
    """分析单首诗"""
    ...
    return {
        "meta": {
            ...
            "series": "森林的孩子·故事诗",
            "episode": poem_id,
            "source_file": f"{poem_id}-{char}.docx",
            "analyzed_at": datetime.now().strftime("%Y-%m-%d"),
            "word_count": word_count,
            "line_count": line_count
        },
        "story_overview": {
            "summary": f"一首关于'{char}'的童话诗，描绘了{line_count}行诗意场景。",
            "genre": ["故事诗", "童诗"],
            "tone": "纯真、美好",
            "pov": "第二人称" if poem_id in ["04", "05", "06", "07", "09", "10", "11", "12", "13", "14", "15", "16"] else "第三人称",
            "length": f"短诗，{line_count}行"
        },
        "story_background": {
            "time": "现代/当代",
            "setting": "森林/自然",
...
<div class="card">
<h1>{char}</h1>
<p class="meta">第{poem_id}篇 - 森林的孩子故事诗</p>
</div>
<div class="card">
<h2>原文</h2>
...
def main():
    ...
    for poem_id in POEMS:
        if poem_id in ["01", "02", "03"]:
            print(f"跳过 {poem_id}-{POEMS[poem_id]} (已完成)")
            continue
            
        try:
            char = POEMS[poem_id]
            content = POEM_CONTENT.get(poem_id, "")
            if not content:
                print(f"跳过 {poem_id}-{char} (无内容)")
                continue
                
            generate_files(poem_id, char, content, output_dir)
            completed += 1
            print(f"[OK] {poem_id}-{char}")
            
        except Exception as e:
            failed.append((poem_id, POEMS.get(poem_id, "?"), str(e)))
            print(f"[FAIL] {poem_id}: {e}")
